<template>
  <div class="min-h-screen max-h-screen flex overflow-hidden bg-white-100 antialiased select-none flex-col">
    <div class="flex-1 overflow-hidden flex">
      ...
      <component :is="tab" class="border-l-1"></component>
    </div>
    <div class="h-6 text-xs flex flex-row bg-gray-100 text-gray-800">
      <div class="bg-blue hover:bg-blue-100 px-3 cursor-pointer h-6 flex items-center">
        <svg class="h-4 text-white" viewBox="0 0 50 52" xmlns="http://www.w3.org/2000/svg">
...
export default {
  ...
  computed: mapState(["project", "opening", "running", "tinkering"]),
  mounted() {
